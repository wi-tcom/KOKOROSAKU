...
const helpLinks=[...d.querySelectorAll(".field-current-note [data-help-link]")].length;check(helpLinks>0&&helpLinks===[...d.querySelectorAll(".field-current-note")].length,"HELP coverage rendered: every 「現在の内容」 note links into the tree (saw "+helpLinks+")");check(d.querySelectorAll(".registry-help").length===0,"the inline per-field Help block is gone (Owner 2026-09-23)");
