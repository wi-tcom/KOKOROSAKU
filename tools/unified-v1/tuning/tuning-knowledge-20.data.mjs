...
export default {
  ...
  "implementation_gaps": [
    "The earlier SAKU Builder Derived Profile Engine still reads removed archetype, intensity, front_control, and professional_reasoning fields and cannot be reused unchanged for SAKU_UNIFIED_SCHEMA_V1.",
