// SAKU Unified V1 — Field Help Registry（Single Source）
// -------------------------------------------------------------------------
...
export const HELP_FIELDS = [
  "character_id", "display_name", "catalog_code", "catalog_group", "role_label",
  "purpose_summary", "primary_value", "character_role", "values",
  "hard_invariants", "human_handoff", "seat_archetype", "seat_intensity",
  "front_minority", "front_selection", "axes_behavior", "axes_presentation",
  "pr_on", "pr_profile", "pr_issue", "pr_prohib", "professional_reasoning",
...
function panelHTML(i18n, fieldKey){
  ...
  return `<div class="saku-help-title">${esc(title)}</div>`
    + row("required", h.required) + row("effect", h.effect)
