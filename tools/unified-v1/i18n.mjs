// SAKU Unified V1 — i18n / Locale runtime
// -------------------------------------------------------------------------
...
export function createI18n(locales, opts = {}) {
  ...
  return {
    ...
    // help(fieldKey): Field Guide metadata と説明を string で返す（無い項目は ""）。
    help(fieldKey) {
      ...
      return { required: pick("required"), effect: pick("effect"),
               meaning: pick("meaning"), example: pick("example"), behavior: pick("behavior"),
