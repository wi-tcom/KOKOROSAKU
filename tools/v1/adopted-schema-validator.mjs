...
import { conformanceLocatorMismatches } from "../unified-v1/unified-schema-v1.mjs";
...
export const ADOPTION_STATUS = Object.freeze({
  ...
  schema: Object.freeze({
    bundled_relative_url: "./saku-unified-character.v1.schema.json",
    source_fallback_relative_url: "../../tests/fixtures/canonical/saku-unified-character.v1.schema.json",
    sha256: ADOPTED_SCHEMA.sha256,
  }),
  resolver_mapping: Object.freeze({
    [EXTENSION_SCHEMA_ID]: Object.freeze({
      bundled_relative_url: "./character-extension.v1.schema.json",
      source_fallback_relative_url: "../../tests/fixtures/canonical/character-extension.v1.schema.json",
